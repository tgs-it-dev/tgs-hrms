...
describe('DesignationService', () => {
  ...
  it('should update designation if title is unique', async () => {
    ...
    jest.spyOn(designationRepo, 'findOne').mockImplementation(async (options: any) => {
  ...
  it('should delete designation', async () => {
    ...
    jest.spyOn(designationRepo, 'findOne').mockResolvedValue(designationWithRelations as any);
