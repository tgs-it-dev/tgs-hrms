...
export class TenantController {
  ...
  @ApiOperation({
    ...
    description:
      "Idempotent. Creates missing tables in the tenant schema: departments, " +
      "designations, teams, employees, billing_transactions, attendance, " +
      "leave_types, leaves, announcements; fixes employees FKs to point at tenant " +
      "schema designations/teams; copies existing public-schema rows for this tenant " +
      "where applicable (including announcements). Safe on Phase 1, already-upgraded, " +
      "or empty schemas.",
  })
