...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Validates a Google ID token (from the frontend Google Sign-In flow) and returns a JWT pair for existing accounts. For new accounts, use /signup/google-init.',
  })
  @ApiBody({
    schema: {
      type: 'object',
