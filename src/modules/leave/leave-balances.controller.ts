import { Controller, Get, Query, Request, ParseIntPipe, DefaultValuePipe } from '@nestjs/common';
...
export class LeaveBalancesController {
  ...
  @ApiOperation({
    ...
    description: 'Returns allocated and used leave days per leave type for the authenticated employee.',
  })
  ...
  async getMyBalances(
    ...
    const balances = await this.leaveService.getMyBalances(id, tenant_id, targetYear);
    return {
