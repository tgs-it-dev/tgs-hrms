...
export class UpdateLeaveEntity1759500000002 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP CONSTRAINT IF EXISTS "FK_leaves_user"`,
    );
    ...
    // Rename columns
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "user_id" TO "employeeId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "from_date" TO "startDate"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "to_date" TO "endDate"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "created_at" TO "createdAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "updated_at" TO "updatedAt"`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_leaves_leaveType" ON "leaves" ("leaveTypeId")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_leaves_tenant" ON "leaves" ("tenantId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP CONSTRAINT IF EXISTS "FK_leaves_employee"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP CONSTRAINT IF EXISTS "FK_leaves_leaveType"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP CONSTRAINT IF EXISTS "FK_leaves_approver"`,
    );
    await queryRunner.query(
    ...
    // Rename columns back
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "employeeId" TO "user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "startDate" TO "from_date"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "endDate" TO "to_date"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "createdAt" TO "created_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" RENAME COLUMN "updatedAt" TO "updated_at"`,
    );

    // Drop new columns
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP COLUMN IF EXISTS "leaveTypeId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP COLUMN IF EXISTS "totalDays"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP COLUMN IF EXISTS "approvedBy"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP COLUMN IF EXISTS "tenantId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP COLUMN IF EXISTS "approvedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leaves" DROP COLUMN IF EXISTS "remarks"`,
    );

    // Add back old type column
    await queryRunner.query(
      `ALTER TABLE "leaves" ADD "type" character varying`,
    );
