...
export class AddManageLeaveTypesPermission1759500000003
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const hrAdminRole = (await queryRunner.query(
      `SELECT id FROM roles WHERE name = 'hr-admin'`,
    )) as Array<{ id: string }>;
    ...
    const manageLeaveTypesPermission = (await queryRunner.query(
