...
export class NormalizeAssetCategories1767000000000
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const defaultCategories = [
      ...
      },
      {
        ...
        description: 'Transportation and mobility assets',
      },
      {
        name: 'Employee Accessories',
        description: 'Employee accessories and supplies',
      },
      ...
      { name: 'Health & Safety', description: 'Health and safety equipment' },
      {
        ...
        description: 'Miscellaneous and custom assets',
      },
    ];
    ...
    const defaultSubcategories = [
      // IT Equipment
      {
        ...
        name: 'Laptop',
        description: 'Portable computers for work',
      },
      {
        categoryName: 'IT Equipment',
        name: 'Desktop',
      ...
      },
      {
        categoryName: 'IT Equipment',
        name: 'Headphones',
        description: 'Audio headsets',
      },
      {
        categoryName: 'IT Equipment',
        name: 'Microphone',
        description: 'Audio recording devices',
      },
      {
        categoryName: 'IT Equipment',
        name: 'Webcam',
        description: 'Video cameras for meetings',
      },
      {
        categoryName: 'IT Equipment',
        name: 'Printer',
      ...
      },
      {
        categoryName: 'IT Equipment',
        name: 'Projector',
        description: 'Presentation projectors',
      },
      {
        categoryName: 'IT Equipment',
        name: 'Display Screen',
        description: 'Large display screens',
      },
      {
        categoryName: 'IT Equipment',
        name: 'Tablet',
      ...
      },
      {
        categoryName: 'Office Equipment',
        name: 'Monitor Stand',
        description: 'Monitor mounting stands',
      },
      {
        categoryName: 'Office Equipment',
        name: 'Whiteboard',
      ...
      // Mobility / Transport
      {
        categoryName: 'Mobility / Transport',
        name: 'Company Car',
      ...
      },
      {
        categoryName: 'Mobility / Transport',
        name: 'Company Bike',
        description: 'Company bicycles',
      },
      {
        categoryName: 'Mobility / Transport',
        name: 'Fuel Card',
        description: 'Fuel payment cards',
      },
      {
        categoryName: 'Mobility / Transport',
        name: 'Transport Pass',
        description: 'Public transport passes',
      },
      {
        categoryName: 'Mobility / Transport',
        name: 'GPS Device',
      ...
      {
        categoryName: 'Employee Accessories',
        name: 'ID Card',
      ...
      },
      {
        categoryName: 'Employee Accessories',
        name: 'Access Badge',
        description: 'Security access cards',
      },
      {
        categoryName: 'Employee Accessories',
      ...
      // Facility Assets
      {
        categoryName: 'Facility Assets',
        name: 'Air Conditioner',
        description: 'Climate control units',
      },
      {
        categoryName: 'Facility Assets',
        name: 'Heater',
        description: 'Heating units',
      },
      {
        categoryName: 'Facility Assets',
        name: 'CCTV Camera',
      ...
      },
      {
        ...
        description: 'Biometric scanners',
      },
      {
        categoryName: 'Facility Assets',
        name: 'UPS',
      ...
      },
      {
        ...
        description: 'Complete furniture sets',
      },
      ...
      {
        categoryName: 'Miscellaneous / Custom',
    ...
    for (const subcategory of defaultSubcategories) {
      ...
      if (!categoryId) {
        console.warn(
          `Category not found for GLOBAL tenant: ${subcategory.categoryName}`,
        );
        continue;
      }
