...
export class SystemLogs1761036420388 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_10f795adf8e1fc6c750a710135" ON "system_logs" ("tenantId") `);
    await queryRunner.query(`CREATE INDEX "IDX_2603d9fdfe248b9cb5d0acc4c3" ON "system_logs" ("userId", "action") `);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_f819ef806b1ee3ce9089fe5b90"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_2603d9fdfe248b9cb5d0acc4c3"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_10f795adf8e1fc6c750a710135"`);
